    ...
    <LayoutGA>
      <Container>
        ...
        <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
          ...
          <h3 className="mb-4 text-2xl font-bold tracking-tight md:text-3xl text-white">
            CSSBUTTONS V2:
          </h3>
          ...
          <h2 className="mt-5 mb-10 space-x-4 text-gray-400">
            ...
            the code when I needed. Before I had this idea I had to go to
            multiple different sites to find a button I liked and wanted to use
            for my project. I started having a bunch of different websites piled
            up in my notes from what buttons to use on the website I was working
            on at the time. So I came up with an idea to have a huge collection
            of buttons that I could simply copy & paste into my website.
          </h2>
          <img src="./images/cssbuttons_grid.webp"></img>
          <h2 className="mt-5 mb-10 space-x-4 text-gray-400">
            The design of the site was fairly simple. I wanted a grid layout
            where I could showcase each button in a box that I could simply
            click on then it would show me the code and the button.
          </h2>
          ...
          <h2 className="mt-5 mb-10 space-x-4 text-gray-400">
            ...
            some websites where I could get the overall feedback for the site
            and it was very popular to my surprise. I have since gotten over
            10000 visitors to the site and great feedback.
          </h2>
          <img src="./images/cssbuttons_all.webp"></img>
          <h2 className="mt-2 mb-10 space-x-6 text-gray-400">
