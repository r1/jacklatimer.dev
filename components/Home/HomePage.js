    ...
    <>
      <div className="flex flex-col items-start max-w-2xl mx-auto mb-16">
        <div className="justify-center mx-auto">
          <h1 className="text-gray-400 mb-4 text-3xl font-bold tracking-tight md:text-5xl">
        ...
        <h2 className="text-gray-400 mx-auto mb-16 text-lg font-semibold text-center">
